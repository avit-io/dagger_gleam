...
```
codegen/                # dagger_codegen — code generator (not published)
  src/dagger/
    ...
    encoder.gleam       # TypeDef → Decl
    printer.gleam       # Decl → Gleam source
    runner.gleam        # orchestration

sdk/                    # dagger_gleam — the published SDK
  src/
    dagger.gleam        # public entrypoint (connect, Client)
    dagger/
      types.gleam       # runtime types (DaggerOp, Value, Try, …)
